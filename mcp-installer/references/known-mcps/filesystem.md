...
**Install package:** `@modelcontextprotocol/server-filesystem`
**Runtime:** npx (Node)
**Auth type:** No Auth — see `references/auth-patterns.md` for full explanation
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `@modelcontextprotocol/server-filesystem`.
