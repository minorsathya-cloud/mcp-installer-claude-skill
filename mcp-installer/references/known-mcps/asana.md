...
**Install package:** `mcp-asana@latest`
**Runtime:** uvx
**Auth type:** PAT or OAuth — see `references/auth-patterns.md` for full explanation

**Config skeleton:**
```json
"asana": {
  "command": "/absolute/path/to/runtime",
  "args": ["mcp-asana@latest"],
  "env": {
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `mcp-asana@latest`.
