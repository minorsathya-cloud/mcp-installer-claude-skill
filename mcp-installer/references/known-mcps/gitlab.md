...
**Install package:** `@modelcontextprotocol/server-gitlab`
**Runtime:** npx (Node)
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `@modelcontextprotocol/server-gitlab`.
