...
**Package:** `mcp-google-calendar@latest`
**Runtime:** uvx
...
**Install package:** `mcp-google-calendar@latest`
**Runtime:** uvx
**Auth type:** Service Account or OAuth — see `references/auth-patterns.md` for full explanation
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `mcp-google-calendar@latest`.
