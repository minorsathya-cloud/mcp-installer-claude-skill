...
**Install package:** `@modelcontextprotocol/server-notion`
**Runtime:** npx (Node)
**Auth type:** OAuth or API Key — see `references/auth-patterns.md` for full explanation
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `@modelcontextprotocol/server-notion`.
