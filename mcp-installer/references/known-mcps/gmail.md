...
**Install package:** `mcp-gmail@latest`
**Runtime:** uvx
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `mcp-gmail@latest`.
