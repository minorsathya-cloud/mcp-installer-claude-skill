...
**Package:** `mcp-server-sentry@latest`
**Runtime:** uvx
**Auth:** API Key
...
**Install package:** `mcp-server-sentry@latest`
**Runtime:** uvx
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `mcp-server-sentry@latest`.
