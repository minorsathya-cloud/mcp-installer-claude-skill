...
**Runtime:** npx (Node)
**Auth:** No Auth (connection string)
...
**Install package:** `@modelcontextprotocol/server-postgres`
**Runtime:** npx (Node)
**Auth type:** No Auth (connection string) — see `references/auth-patterns.md` for full explanation
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `@modelcontextprotocol/server-postgres`.
