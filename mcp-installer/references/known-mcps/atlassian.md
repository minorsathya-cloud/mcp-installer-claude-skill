...
**Install package:** `mcp-atlassian@latest`
**Runtime:** uvx
**Auth type:** PAT — see `references/auth-patterns.md` for full explanation
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `mcp-atlassian@latest`.
