...
**Install package:** `mcp-server-sqlite@latest`
**Runtime:** uvx
**Auth type:** No Auth (file path) — see `references/auth-patterns.md` for full explanation
...
**To get exact env vars and args:** fetch and read the official docs or GitHub README for `mcp-server-sqlite@latest`.
